      ...
      <Reveal delay={0.32}>
        <div style={{
          ...
          <div style={{
            ...
            color: WL.ink, opacity: 0.7, whiteSpace: 'pre-line', lineHeight: 1.5
          }}>{D.shuttle.sub}</div>
        </div>
      </Reveal>
